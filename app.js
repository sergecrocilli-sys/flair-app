...
function extraireRegionImportDepuisTexte(texte) {
  ...
  const aliasesLocalisation = [
    { valeur: 'plumelin', region: 'Bretagne', departement: 'Morbihan' },
    { valeur: 'cité marine', region: 'Bretagne', departement: 'Morbihan' },
    { valeur: 'cite marine', region: 'Bretagne', departement: 'Morbihan' },
...
function appliquerPlancherTimingStrategique(score, signal = {}, resultat = {}, timing = {}, enrichissement = null) {
  ...
  if (phase === 'urgence_0_3_mois') {
    plancher = geo.niveau === 'principale' ? 85 : geo.niveau === 'secondaire' ? 78 : 68;
  } else if (phase === 'contact_ideal_3_6_mois') {
    plancher = geo.niveau === 'principale' ? 80 : geo.niveau === 'secondaire' ? 74 : 64;
  }
  ...
  if (profil === 'detection' && qualiteInspection) {
    plancher += geo.niveau === 'eloignee' ? 4 : 2;
  }
