...
function labelProfilMetier(value) {
  const labels = {
    agro_pesage: 'Pesage / étiquetage industriel',
    agro_detection: 'Détection / contrôle qualité',
    agro_vision: 'Vision industrielle / contrôle qualité',
    agro_packaging: 'Packaging / films / étiquettes',
    process_agro: 'Process agroalimentaire',
...
function afficherOnboardingMetier(profil = {}) {
  ...
  document.getElementById('onboardingProfilMetier').value = profil.profil_metier || invitationCourante?.profil_metier || 'agro_pesage';
